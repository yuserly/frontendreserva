    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="col-md-7 text-center">
                ...
                <img src="{{asset('images/icon-escanear.png')}}" class="img-fluid" width="70px">

                <h5 class="pt-3" style="font-weight: bold;line-height: 1;color: #000;font-size: 22px">¡Comencemos!</h5>
                <h5 style="font-weight: bold;line-height: 1;color: #000;font-size: 22px">Escanea el código QR</h5>
        ...
        <div class="row justify-content-center mt-4 mb-5">
        	...
        	<div class="col-xs-6 col-md-4">
				 ...
				 <a href="{{url('/escanear1')}}" class="btn btn-siguiente">Escanear</a>
