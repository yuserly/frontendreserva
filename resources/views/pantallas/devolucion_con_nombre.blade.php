    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-3">
            ...
            <div class="col-md-7 text-center">
                ...
                <h6 class="mb-3">Diana te lo agradecerá.</h6>
        ...
        <div class="row justify-content-center">
        	<div class="col-md-6">
        		<h6 class="mb-3 mt-4 text-center">Por favor completa tus datos de contacto para devolverla</h6>
        ...
        <div class="row justify-content-center mt-4 mb-5">
        	...
        	<div class="col-xs-6 col-md-4">
				 ...
				 <a href="{{url('/devolucion2')}}" class="btn btn-siguiente">Enviar</a>
