    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-3">
            ...
            <div class="col-md-7 text-center">
                ...
                <h6>Hola, Admin del Colegio</h6>
                <p style="font-weight: bold;font-size: 17px;">haz encontrado una prenda perdida,
                te pedimos por favor que la reportes para notificarla.</p>
                <h6 class="mt-2">Diana te lo agradecerá</h6>
        ...
        <div class="row justify-content-center">
            ...
            <ul class="list-group datosestudiante">
                <li class="list-group-item">Colegio: Pedro de Valdivia</li>
                <li class="list-group-item">Alumno: Diana Montalva</li>
                <li class="list-group-item">Curso: 3° F</li>
                <li class="list-group-item">Apoderado: José Miguel Montalva</li>
            </ul>
        ...
        <div class="row justify-content-center mt-4 mb-5">
        	...
        	<div class="col-xs-6 col-md-4">
				 ...
				 <button type="button" class="btn btn-siguiente">Reportar</button>
