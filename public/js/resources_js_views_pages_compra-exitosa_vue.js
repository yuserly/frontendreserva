  ...
  methods: {
    ...
    enviar: function enviar(dato) {
      ...
      this.axios.post("/api/uptpublicventa", form).then(function (res) {
        ...
        _this3.mensaje1 = false;
        _this3.mensaje2 = true; //this.$router.push("/");
      })["catch"](function (error) {
        console.log("error", error);
      });
    },
      ...
      _c("LayoutTienda", [
              ...
              _c("div", { staticClass: "row justify-content-center mt-5" }, [
                _c("div", { staticClass: "col-md-7 text-center" }, [
                  _c(
                    "h1",
                    {
                      class: [_vm.mensaje1 ? "d-block" : "d-none"],
                      staticStyle: {
                        color: "#04d28c",
                        "font-size": "3rem",
                        "font-weight": "bold",
                  ...
                  _c(
                    "h1",
                    {
                      class: [_vm.mensaje2 ? "d-block" : "d-none"],
                      staticStyle: {
                        color: "#04d28c",
                        "font-size": "3rem",
                        "font-weight": "bold",
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            "Revisa tu correo electronico donde enviamos el detalle de tu orden de compra."
                          ),
                        ]
                      ),
                    ]
        ...
        _c("section", { staticClass: "seccion3" }, [
          _c("div", { staticClass: "container" }, [
            _c(
              "div",
              { staticClass: "row mt-4 mb-5 d-flex justify-content-center" },
              [
                _c("div", { staticClass: "col-md-6" }, [
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-opc float-start",
                      class: [_vm.mensaje1 ? "d-block" : "d-none"],
                      on: {
                  ...
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-opc2 float-end",
                      class: [_vm.mensaje1 ? "d-block" : "d-none"],
                      on: {
                        click: function ($event) {
                          return _vm.enviar(1)
                    ...
                    [
                      _vm._v(
                        "\n                            Sí, deseo publicar el nombre del alumno.\n                        "
                      ),
                    ]
                  ),
                ]),
